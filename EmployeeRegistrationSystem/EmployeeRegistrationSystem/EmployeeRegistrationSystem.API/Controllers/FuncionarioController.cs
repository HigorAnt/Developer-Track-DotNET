...
public class FuncionarioController : ControllerBase
{
    ...
    public FuncionarioController(FuncionarioContext context, IConfiguration configuration)
    {
        _context = context;
        _connectionString = configuration.GetValue<string>("ConnectionStrings:SaConn");
